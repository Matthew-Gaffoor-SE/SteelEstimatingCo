            ...
            <div class="search-bar-main">
                ...
                <?php
                    ...
                    if(isset($_GET['search']))
                    {
                        ...
                        $query = "SELECT * FROM Listings WHERE CONCAT(listingID, Type, Title, Description, Claimed, Imgpic) LIKE '%$filtervalues%' AND userID='$_SESSION[usersID]' AND Claimed=1 ORDER BY listingID DESC LIMIT 8";
