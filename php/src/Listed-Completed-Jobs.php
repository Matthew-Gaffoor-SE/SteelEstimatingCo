...
?>
    <header class="header-body">
        ...
        <div class="active-job-box">
            <h1 class="active-job-header">Completed Job List:
                <p class="view-all-link" onclick="location.href='Listed-Completed-All.php'">[ Search ]</p>
            </h1>
            <div class="aj-box-containers">
            <?php
                    include ('includes/conn.inc.php');
                    $sqli = "SELECT * FROM Listings WHERE userID=$_SESSION[usersID] AND Claimed=3 ORDER BY listingID DESC LIMIT 4";
