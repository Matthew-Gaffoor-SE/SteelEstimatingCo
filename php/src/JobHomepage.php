...
?>
    <header class="header-body">
        ...
        <div class="profile-box">
            <?php
                if(isset($_SESSION["usertype"]) == "Customer") {
                    echo "<div class=\"option-box-container\">";
                        echo "<div class=\"display-boxes\" onclick=\"location.href='Listed-Active-Jobs.php'\">";
                            if ($numRows == 0)
                            {
                            ...
                            echo $numRows;
                            echo "</div>";
                            echo "<p class=\"job-desc-txt\"> Listed Jobs </p>";
                        echo "</div>";
            ...
            <a href="/img/Template.jpeg" class="template-download-text" download>Download Template</a>
            <button class="job-new-button" type="button" onclick="location.href='PostNewJob.php'">Post New Job</button>
        </div>
