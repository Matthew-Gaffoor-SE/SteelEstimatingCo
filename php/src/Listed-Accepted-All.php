<?php
    ...
    $stmt = $mysqli->prepare("SELECT listingID, userID, Type, Title, Description, Claimed, estimatorID, Imgpic FROM Listings WHERE userID='$_SESSION[usersID]' AND Claimed=2");
    $stmt->execute();
...
?>
    <header class="header-body">
        ...
        <div class="active-job-box">
            <h1 class="active-job-header">All Accepted Jobs: 
            <div class="search-bar-main">
                ...
                <?php
                    ...
                    if(isset($_GET['search']))
                    {
                        ...
                        $query = "SELECT * FROM Listings WHERE CONCAT(listingID, Type, Title, Description, Claimed, Imgpic) LIKE '%$filtervalues%' AND userID='$_SESSION[usersID]' AND Claimed=2 ORDER BY listingID DESC LIMIT 8";
